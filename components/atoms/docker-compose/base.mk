...
docker-compose-up: $(DOCKER_COMPOSE_UP_DEPS)
	$(DOCKER_COMPOSE_ENVS) docker compose $(DOCKER_COMPOSE_OPTS) up $(DOCKER_COMPOSE_TARGET_SERVICES) $(DOCKER_COMPOSE_UP_OPTS)

.PHONY: docker-compose-upd
docker-compose-upd: $(DOCKER_COMPOSE_UPD_DEPS)
	$(DOCKER_COMPOSE_ENVS) docker compose $(DOCKER_COMPOSE_OPTS) up -d --wait $(DOCKER_COMPOSE_TARGET_SERVICES) $(DOCKER_COMPOSE_UP_OPTS)

.PHONY: docker-compose-down
docker-compose-down: $(DOCKER_COMPOSE_DOWN_DEPS)
	$(DOCKER_COMPOSE_ENVS) docker compose $(DOCKER_COMPOSE_OPTS) down $(DOCKER_COMPOSE_TARGET_SERVICES) $(DOCKER_COMPOSE_DOWN_OPTS)
